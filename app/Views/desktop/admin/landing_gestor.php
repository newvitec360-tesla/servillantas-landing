...
<head>
  ...
  <link rel="stylesheet" href="/public/assets/css/landing_admin.css" />
  <style>
...
<body>
    ...
    <main class="main-panel">
      <header class="topbar">
        ...
        <div class="top-actions">
          <a class="ghost-btn" href="/" target="_blank" rel="noopener">Ver escritorio</a>
          <a class="ghost-btn" href="/" target="_blank" rel="noopener">Ver móvil</a>
          <button class="primary-btn" id="saveAllBtn">Guardar borrador</button>
        </div>
      </header>

      <section class="notice-bar" id="connection-status-bar">
          ...
          <article class="form-card wide">
            ...
            <div class="upload-grid">
              <div class="upload-box" data-spec="Logo principal: PNG o SVG transparente, 420x220 px recomendado, máximo 500 KB.">
                <img src="/public/assets/landing/img/logo-servillantas.png" alt="Preview logo principal" />
                <div>
              ...
              <div class="upload-box" data-spec="Logo 24 horas: PNG o SVG transparente, 360x160 px recomendado, máximo 400 KB.">
                <img src="/public/assets/landing/img/logo-24-horas.png" alt="Preview logo 24 horas" />
                <div>
      ...
      <section class="panel" id="tab-banner">
        ...
        <div class="slider-editor">
          <article class="slide-card active-slide">
            ...
            <div class="slide-preview" style="background-image:url('/public/assets/landing/img/hero-bg.jpg')"></div>
      ...
      <section class="panel" id="tab-destacados">
        ...
        <div class="cards-editor three">
          ...
          <article class="edit-card">
            <img src="/public/assets/landing/img/mini-pesados.jpg" alt="Livianos y pesados" />
            <label>Título</label>
      ...
      <section class="panel" id="tab-nosotros">
        ...
        <div class="form-grid">
          ...
          <article class="form-card image-side">
            ...
            <img src="/public/assets/landing/img/about-building.jpg" alt="Fachada" />
      ...
      <section class="panel" id="tab-servicios">
        ...
        <div class="service-editor-list">
          <article class="service-edit-row">
            <span class="service-number">01</span><img src="/public/assets/landing/img/service-montallantas.jpg" alt="Montallantas" />
          ...
          <article class="service-edit-row">
            <span class="service-number">02</span><img src="/public/assets/landing/img/service-alineacion.jpg" alt="Alineación" />
          ...
          <article class="service-edit-row">
            <span class="service-number">03</span><img src="/public/assets/landing/img/service-aceite.jpg" alt="Cambio de aceite" />
      ...
      <section class="panel" id="tab-aliados">
        ...
        <div class="form-grid">
          <article class="form-card wide image-side">
            ...
            <img class="wide-preview" src="/public/assets/landing/img/alliances-strip.png" alt="Aliados" />
      ...
      <section class="panel" id="tab-contacto">
        ...
        <div class="form-grid">
          ...
          <article class="form-card wide image-side">
            ...
            <img class="wide-preview" src="/public/assets/landing/img/map-location.jpg" alt="Mapa" />
      ...
      <section class="panel" id="tab-publicar">
        ...
        <div class="publish-grid">
          <article class="publish-card">
            ...
            <button class="outline-btn">Guardar borrador</button>
          </article>
          <article class="publish-card">
            <span>02</span>
            <h3>Previsualizar</h3>
            <p>Abre la landing con los cambios temporales.</p>
            <button class="outline-btn">Vista previa</button>
          </article>
          <article class="publish-card hot">
            <span>03</span>
            <h3>Publicar</h3>
            <p>Envía los cambios a producción.</p>
            <button id="publishBtn" class="primary-btn">Publicar cambios</button>
          </article>
        </div>
  ...
  <script src="/public/assets/js/landing_admin.js"></script>
</body>
</html>
